    ...
    def get_rss_feed_links(self):
        ...
        for category in categories:
            try:
                ...
                logger.exception('Error: {0} while getting {1}'.format(e,category))
                self.errors.append(error_to_string(e))
            else:
                ...
                if request.status_code == 200:
                    ...
                    for article in articles:
                        try:
                            ...
                            publication_date = pytz.timezone("Europe/Helsinki").localize(datetime.strptime(date, '%Y-%m-%dT%H:%M:%SZ'), is_dst=None)
